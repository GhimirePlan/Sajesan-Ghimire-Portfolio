...
export const config: TConfig = {
  ...
  sections: {
    about: {
      p: "Introduction",
      h2: "Overview.",
      content: `Electrical Engineer specializing in power distribution, solar PV design, and automation—driven by a passion for building sustainable and efficient energy solutions.
`,
    },
    experience: {
